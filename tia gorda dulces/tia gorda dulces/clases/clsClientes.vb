...
#Region " Editar Datos"
    Public Sub Agregar(ByVal Nombre_Nuevo As String, ByVal Direccion As String, ByVal Celular As String, ByVal Instagram As String)
        Dim db As New OleDb.OleDbConnection(My.Resources.Cadena_Conexion)
        Dim dc As New OleDb.OleDbCommand($"INSERT INTO Clientes (Nombre, Dirección, Celular, Instagram) VALUES('{Nombre_Nuevo}', '{Direccion}', '{Celular}', '{Instagram}' ) ", db)
        db.Open()
        dc.ExecuteNonQuery()
        db.Close()
    ...
    Public Sub Editar(ByVal id As Integer, ByVal Nombre_Nuevo As String, ByVal Direccion As String, ByVal Celular As String, ByVal Instagram As String)
        Dim db As New OleDb.OleDbConnection(My.Resources.Cadena_Conexion)
        Dim dc As New OleDb.OleDbCommand($"UPDATE Clientes SET Nombre='{Nombre_Nuevo}', Dirección='{Direccion}', Celular='{Celular}', Instagram='{Instagram}' WHERE ID={id} ", db)
        db.Open()
        dc.ExecuteNonQuery()
        db.Close()
